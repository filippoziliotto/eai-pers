...
def main(args):
    ...
    optimizer, scheduler = get_optimizer(
        ...
        scheduler_name=cfg.scheduler.scheduler,
    ...
    if args.mode in ['train']:    
        train_and_validate(
            ...
            load_checkpoint_=cfg.checkpoint.load_checkpoint,
            save_checkpoint_= cfg.checkpoint.save_checkpoint,
        ...
        validate(
            ...
            device=cfg.device.type,
            use_wandb=cfg.logging.wandb.use_wandb,
            load_checkpoint= cfg.checkpoint.load_checkpoint,
            checkpoint_path= cfg.checkpoint.path,
            mode= cfg.training.mode,
            config=cfg,
        )
